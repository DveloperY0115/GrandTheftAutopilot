...
python tests.py configs/culane.py --test_model path_to_culane_18.pth --test_work_dir ./tmp

python tests.py configs/tusimple.py --test_model path_to_tusimple_18.pth --test_work_dir ./tmp
```
...
# this will tests the speed with a simple protocol and requires no additional dependencies

python speed_real.py
# this will tests the speed with real video or camera input
```
